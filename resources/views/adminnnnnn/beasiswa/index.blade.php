            ...
            <div class="card my-4">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                  <h6 class="text-white text-capitalize ps-3">Beasiswa Table</h6>
                </div>
              </div>
              <div class="card-body px-0 pb-2">
                <div class="table-responsive p-0">
                  <a href="{{ route('create.beasiswa') }}" class="badge badge-sm bg-gradient-success m-4" >Tambah</a>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                          ...
                          <a href="/admin/beasiswa/show/{{ $item->id }}" class="badge badge-sm bg-gradient-info" >Lihat</a>
                          <a href="/admin/beasiswa/edit/{{ $item->id }}" class="badge badge-sm bg-gradient-warning" >Edit</a>
                            @csrf
                            @method('DELETE')
