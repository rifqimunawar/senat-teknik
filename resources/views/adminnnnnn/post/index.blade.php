            ...
            <div class="card my-4">
              ...
              <div class="card-body px-0 pb-2">
                <div class="table-responsive p-0">
                  <a href="{{ route('create.post') }}" class="badge badge-sm bg-gradient-success m-4" >Tambah Post</a>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                          ...
                          <a href="/admin/post/edit/{{ $item->id }}" class="badge badge-sm bg-gradient-warning" >Edit</a>
                            @csrf
                            @method('DELETE')
